...
bun ${SKILL_DIR}/scripts/x-article.ts article.md

# With custom cover image
bun ${SKILL_DIR}/scripts/x-article.ts article.md --cover ./cover.jpg

# Actually publish
bun ${SKILL_DIR}/scripts/x-article.ts article.md --submit
```
...
bun ${SKILL_DIR}/scripts/md-to-html.ts article.md

# Output HTML only
bun ${SKILL_DIR}/scripts/md-to-html.ts article.md --html-only

# Save HTML to file
bun ${SKILL_DIR}/scripts/md-to-html.ts article.md --save-html /tmp/article.html
```
...
- **Content not pasting**: Check HTML clipboard: `bun ${SKILL_DIR}/scripts/copy-to-clipboard.ts html --file /tmp/test.html`
