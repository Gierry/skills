...
```bash
# Text generation
bun ${SKILL_DIR}/scripts/main.ts "Your prompt"
bun ${SKILL_DIR}/scripts/main.ts --prompt "Your prompt" --model gemini-3-flash

# Image generation
bun ${SKILL_DIR}/scripts/main.ts --prompt "A cute cat" --image cat.png
bun ${SKILL_DIR}/scripts/main.ts --promptfiles system.md content.md --image out.png

# Vision input (reference images)
bun ${SKILL_DIR}/scripts/main.ts --prompt "Describe this" --reference image.png
bun ${SKILL_DIR}/scripts/main.ts --prompt "Create variation" --reference a.png --image out.png

# Multi-turn conversation
bun ${SKILL_DIR}/scripts/main.ts "Remember: 42" --sessionId session-abc
bun ${SKILL_DIR}/scripts/main.ts "What number?" --sessionId session-abc

# JSON output
bun ${SKILL_DIR}/scripts/main.ts "Hello" --json
```
